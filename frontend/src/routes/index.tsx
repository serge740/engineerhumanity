...
const ProfessionalSkills = lazy(() => import('../pages/program/ProfessionalSkills'));
const ResearchInnovation = lazy(() => import('../pages/program/ResearchInnovation'));
...
const router = createBrowserRouter([
    {
        ...
        children: [
            ...
            {
                path: "programs/professional-skills",
                element: <SuspenseWrap><ProfessionalSkills /></SuspenseWrap>
            },
            {
                path: "programs/research-innovation",
                element: <SuspenseWrap><ResearchInnovation /></SuspenseWrap>
            },
            {
            ...
            },
            {
                ...
                element: <SuspenseWrap><UpcomingEventDetail /></SuspenseWrap>
            },
