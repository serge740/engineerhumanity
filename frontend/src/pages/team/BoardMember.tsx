...
import image8 from '../../assets/team/board/image8.png'
...
const BoardMembers: React.FC = () => {
  ...
  const boardMembers: BoardMember[] = [
    ...
    },
    {
      ...
      role: 'member',
      bio: "Ndahiriwe is a senior health systems consultant with over 20 years of experience across clinical practice, academia, regulation, and health policy in Rwanda and the East African region. He has led major national and regional initiatives focused on strengthening health workforce standards, accreditation systems, institutional governance, and quality assurance expertise that directly support Engineers4Humanity's Public Health Engineering mission.\n\nWith deep experience in developing scopes of practice, training standards, accreditation frameworks, and compliance audits, he brings a strong foundation for improving the quality and safety of community-level health and WASH services. His leadership in curriculum development, education harmonization, and higher education quality assurance aligns with Engineers4Humanity's commitment to delivering high-quality vocational training and expanding job-creation pathways for refugee and host communities.\n\nNdahiriwe has served on high-level Ministry of Health technical committees, regulatory councils, and university governance structures, and has contributed to major health systems strengthening projects, including serving as Technical Lead for the HSS NEXT project. He currently consults with Building Systems for Health on a Gates Foundation–funded Primary Health Care Performance Management initiative in Rwanda and Ghana.\n\nHe holds bachelor's degrees in Diagnostic Imaging and Pharmaceutical Sciences, a master's degree in medical Imaging, and a Master of Public Health in  Health. Fluent in English and French, he brings strong strategic, analytical, and governance expertise to the Board of Engineers4Humanity."
    },
    {
      id: 8,
      name: "Steven Malecek",
      credentials: "PhD",
      title: "Board Member | Engineering & Entrepreneurship Committee",
      image: image8,
      linkedIn: "https://www.linkedin.com/in/stevemalecek/",
      role: 'member',
      bio: "As Engineers4Humanity Board Member, committed to strengthening refugee self-reliance and wellbeing through innovative public health engineering and entrepreneurial pathways.\n\nEngineer Steven is a water and energy development specialist; the Founder and Principal of Water Pathways, LLC. He brings together technical, business, and legal expertise to serve international development through geoscience applications, project coordination, and collaboration with companies, nonprofits, and local organizations across water, solar power, smallholder agriculture, and market access. Growing up on a farm instilled an appreciation of agriculture, weather, and markets that affect farmers in developing countries.\n\nSteve's current work is rooted in firsthand experience. Site visits to rural communities in Kenya, Zambia, and Zimbabwe revealed the profound human toll of water insecurity — on health, economic opportunity, and the daily burden on women and girls who travel long distances to reach often-contaminated sources. In response, he has focused on groundwater development through regional hydrogeological assessments, pre-drill geophysical surveys, and drilling operations. Results have demonstrated how a successful water well, combined with solar pumping and drip irrigation, can transform smallholder farming yields and open market access — directly advancing UN Sustainable Development Goals #2 and 6.\n\nProfessionally, Steven is a Licensed Geophysicist in Texas with more than 30 years of experience in the oil and gas industry, having worked with Mobil Oil, Saudi Aramco, PetroTel Consulting, and Kosmos Energy across Europe, the Middle East, Southeast Asia, and West Africa. His graduate degrees include a MSc in Geophysics (University of British Columbia), MSc in Engineering Management (Missouri S&T), an MBA (UT Dallas), an LLM in Energy Law and Policy, and a PhD in Water Law and Policy (University of Dundee, Scotland).\n\nIn his role as a Board Member on the Engineering & Entrepreneurship Committee, he provides strategic technical guidance across Public Health Engineering, WASH (Water, Sanitation and Hygiene), renewable energy, environmental protection, and irrigation initiatives.\n\nHe further enhances refugee and host community long term resilience and self reliance by supporting smallholder farming entrepreneurship and equipping rural communities with advanced, sustainable, and affordable irrigation practices."
    },
  ];
