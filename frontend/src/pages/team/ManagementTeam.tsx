...
import imageDaf from '../../assets/team/management/daf.jpeg'
import imageCyubahiro from '../../assets/team/management/cyubahiro.jpeg'
...
import image31 from '../../assets/team/management/image31.png'
// member images
...
const ManagementTeamPage: React.FC = () => {
  ...
  const teamMembers: TeamMember[] = [
    ...
    {
      id: 10,
      name: "Gentille Kamanzi",
      title: "Director of Finance and Administration",
      image: imageDaf,
      bio: "Experienced woman, a mom with Christian values. Holds a bachelor's degree in finance, along with certifications in insurance, family protection, community empowerment, financial literacy, and healthcare.",
      category: 'operations'
    },
    {
      id: 7,
      ...
      credentials: "M.Ed",
      title: "Director of Education Program  ",
      image: image7,
    ...
    },
    {
      ...
      title: "Director of Engineering Program  ",
      image: imageCyubahiro,
      category: 'programs'
    },
    ...
    {
      id: 20,
      name: "Eng. Alex Rukamirwa",
      
      title: " Director of Public Health Engineering ",
      image: image30,
    ...
    },
    {
       ...
       name: "Vianney Mutete",
       // credentials: "MBA",
       title: "Director of Youth Leadership & Mentorship",
       image: image31,
       linkedIn: "https://www.linkedin.com/in/vianney-mutete-73302b263/?skipRedirect=true",
       category: 'programs',
       bio:`Vianney Mutete is the Director of the Youth Leadership and Mentorship Program at Engineers4Humanity, leading initiatives that equip young people with the skills, confidence, and character to become impactful leaders. He holds a Bachelor's degree in Education from the University of Rwanda, where he also served in key student leadership roles and mentored peers.
       
 Vianney brings professional experience from IEE Rwanda as a Teaching Assistantships Mentor and Continuous Development Advisor, supporting teacher development, instructional quality, and youth empowerment. He is committed to nurturing young leaders through mentorship, academic support, and values‑driven personal growth.`
     },
    {
      id: 29,
      name: "Theoneste Habimana",
      credentials: "PMP, QS",
      title: " Dirctor of Planning & Monitoring Valuations",
      image: image24,
    ...
    },
     {
      ...
      title: "Director of Girl & Women Engagement ",
      image: image15,
      category: 'programs'
    },
   
     {
      id: 30,
      name: "Bosco S. Rusine",
      title: "Director of Research, Innovation, and University Partnership",
      image: image28,
  ...
  id: 28,
  name: "Andy Bayingana",
  title: "Director of Art & Storytelling",
  image: image20,
  ...
  category: 'operations'
    ...
    {
      id: 11,
      name: "Eng. Octavien Rugirangoga",

      title: "Job opportunity & Internship",
      image: image8,
      category: 'programs'
    },
    ...
    {
      id: 18,
      name: "Jackson Dushimimana Mutega",
      title: " Research, Innovation, and University Partnership",
      image: image17,
    ...
    },
    {
      ...
      name: "Amani Faustin",
      credentials: "MBA",
      title: "Youth Mentorship & Job Opportunity ",
      image: image12,
      category: 'programs'
    },
          ...
          <div className="p-8">
            ...
            <div className="bg-gray-50 p-6 rounded-xl border-l-4 border-green-600">
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                {!member.bio && member.title.includes('Founder') &&
                ...
                {!member.bio && member.title.includes('Board Chair') && !member.title.includes('Vice') &&
                ...
                {!member.bio && member.title.includes('Vice Chair') && member.title.includes('Education') &&
                ...
                {!member.bio && member.title.includes('Vice Chair') && member.title.includes('Engineering') &&
                ...
                {!member.bio && member.title.includes('Country Director') &&
                ...
                {!member.bio && member.title.includes('Chief of Operations') &&
                ...
                {!member.bio && member.title.includes('Education Program Manager') &&
                ...
                {!member.bio && member.title.includes('Engineering Program Manager') &&
                ...
                {!member.bio && member.title.includes('Finance & Accounting') &&
                ...
                {!member.bio && member.title.includes('Youth Mentorship') &&
                ...
                {!member.bio && member.title.includes('Marketing') &&
                ...
                {!member.bio && member.title.includes('Construction Project') &&
                ...
                {!member.bio && member.title.includes('Environmental Project') &&
                ...
                {!member.bio && member.title.includes('Media') &&
                ...
                {!member.bio && member.title.includes("Girl Students' Representative") &&
                ...
                {!member.bio && member.title.includes('Youth Job Opportunity') &&
                ...
                {!member.bio && member.title.includes('Vocational Training') &&
