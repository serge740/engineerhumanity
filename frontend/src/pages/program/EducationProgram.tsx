                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-8xl mx-auto">
                        <div className="bg-white rounded-lg shadow-lg p-8">
                            ...
                            <p className="text-gray-700 mb-4 leading-relaxed">
                                In Rwanda refugee camps, we are dedicated to fostering growth and opportunity by offering high school and university scholarships focused on STEM fields. By collaborating with the government, we provide valuable vocational training for refugee youth, equipping them with the essential skills for success in the job market. This approach not only enhances their individual prospects but also benefits their communities.
                            </p>
                            <p className="text-gray-700 mb-8 leading-relaxed">
                                We actively conduct community outreach campaigns, engage directly with youth, and offer mentorship and career guidance to empower them with essential information about scholarships and universities. We assert that an educated community is crucial for advancing national development and integrating successfully into Rwandan society. Education serves as a powerful catalyst for change, driving progress and making a significant impact both locally and globally.
                            </p>
