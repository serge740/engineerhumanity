        ...
        <div className="font-sans text-gray-800">
            ...
            <section id="our-impact" className="py-16 md:py-24 bg-white scroll-mt-24">
                <div className="max-w-7xl mx-auto px-4 sm:px-6">
                    ...
                    <div className="text-lg text-gray-700 leading-relaxed mb-10 max-w-4xl space-y-4">
                        <p>
                            Eng. Eric KAMANZI's humanitarian journey began in 2004, serving over 100 orphaned students as a high-school volunteer with the Association of Survivors of the 1994 Genocide Against the Tutsi (AERG). By 2007, during his first year at the University of Rwanda, he encountered Pastor Rick Warren in Kigali and read <em>The Purpose Driven Life</em>, a message that shaped his sense of calling. In 2008, he mobilized refugee youth to form the Refugee Youth Club – Forum Amis de la Paix and in 2009, together with his colleague, they established Hope School, which went on to educate more than 500 refugee students and supporting hundreds of young refugees completed university study.
                        </p>
                        <p>
                            In response to persistent challenges in public health engineering, youth unemployment, and limited vocational pathways, Eric founded a social enterprise Engineers4Humanity in 2020.
                        </p>
                        <p>
                            Since then, Engineers4Humanity has been transforming lives across Rwanda. Through education scholarships, vocational training, environmental stewardship, and peace-building programs, the organization empowers refugees and underserved communities to build self-reliant, dignified, and resilient futures.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-5 mb-12">
                        {[
                            ...
                            { icon: <Droplets className="w-8 h-8" />, stat: '100+', label: 'Environmental and Social Safeguarding Projects', color: 'blue' },
                            { icon: <Globe className="w-8 h-8" />, stat: '17+', label: 'Years of Founder in Humanitarian Service', color: 'purple' },
                        ].map((item, i) => (
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        {[
                            ...
                            },
                            {
                                ...
                                desc: 'Designing affordable water supply systems, constructing sanitation facilities, and conducting environmental and social safeguarding studies across Rwanda.',
                                icon: <Droplets className="w-6 h-6" />,
                                color: 'green'
                            },
                            {
                                title: 'Leadership & Peacebuilding',
                                desc: 'Empowering young people and women as servant leaders and peace advocates in Rwanda through research, community outreach campaigns, and collaborative partnerships with regional organizations.',
