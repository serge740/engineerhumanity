            ...
            <section id="article-publication" className="py-16 md:py-24 bg-white scroll-mt-24">
                <div className="max-w-7xl mx-auto px-4 sm:px-6">
                    ...
                    <p className="text-lg text-gray-700 leading-relaxed mb-10 max-w-3xl">
                        Explore our research, publications, and media coverage that document our journey and insights on refugee empowerment, engineering solutions, and sustainable development.
                    </p>

                    <div className="grid md:grid-cols-3 gap-6">
                        {[
                            {
                                title: '" Breaking Boundaries" – A Resilient Refugee\'s Journey from Refugee Camps to Engineer of Change',
                                type: 'Book',
                                desc: 'Founder Eric Kamanzi shares his refugee journey and the founding story of Engineers4Humanity. Available on Amazon.',
                            ...
                            },
                            {
                                ...
                                type: 'Report',
                                desc: 'A comprehensive report on the Hope School initiative that provided education to 500+ refugee students in the Gihembe refugee camp from 2009 to its unfortunate closure in 2016.',
