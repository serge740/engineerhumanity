                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-6 md:gap-12 items-center mb-8 md:mb-12">
                        <div className="space-y-4 md:space-y-6 text-base md:text-lg leading-relaxed text-gray-700">
                            ...
                            <p>
                                In 2024, as a refugee, Eric pursued his humanitarian mission by establishing the nonprofit Engineers4Humanity in the USA — a 501(c)(3) — to guide and support its social enterprise in Rwanda.
                            </p>
                        </div>
                        <div>
                            <img
                    ...
                    <div className="bg-gray-50 p-4 sm:p-6 md:p-8 rounded-xl md:rounded-2xl space-y-4 md:space-y-6 text-base md:text-lg leading-relaxed text-gray-700">
                        ...
                        <p>
                            Eric's humanitarian journey began in 2008, when he gathered other young refugee students to explore how they could find lasting solutions to their daily challenges. They founded the youth club — Forum Amis de la Paix. Eric served as the organization's first president and later as board chair. One notable achievement of the Forum is the establishment of Hope School in 2009, a refugee initiative school in the Gihembe refugee camp. Nonprofit organizations, including UNHCR, stopped offering free high school education programs, due to a funding shortage.
                        </p>
                        <p>
                            Eric, along with his refugee friends, founded the Hope School that offered education grades <strong>from grade 10 to 12</strong>. More than 500 students graduated from the school. Their lives and opportunities have remarkably improved. After graduating from the University of Rwanda as a civil engineer, Eric found that engineering could fulfill his mission. In 2020 in Rwanda, he launched the Engineers4Humanity Consultancy, a social enterprise that provides public health engineering, STEM education, and vocational training services for young refugees.
                        </p>
                        <p>
                            In 2024, Eric pursued his humanitarian mission by establishing the nonprofit Engineers4Humanity in the U.S. to guide and support its social enterprise in Rwanda.
                        </p>
                        <p className="font-semibold text-gray-900">
                            For more about our story, check out our founder's book, <em>Breaking Boundaries</em>, and Hope School Alum's Testimony at the link below.
                        </p>
                        <div className="mt-4">
                            <a
                            ...
                            >
                                ...
                                Read <em className="italic">Breaking Boundaries</em> on Amazon
                            </a>
                        </div>
                    </div>
                </div>
