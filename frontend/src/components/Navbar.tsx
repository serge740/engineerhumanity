                            ...
                            >
                                ...
                                <div className="grid grid-cols-3 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <NavLink to="/programs/professional-skills" className={dropdownLinkClasses} onClick={() => setProgramsDropdownOpen(false)}>
                                            Professional Skills Development
                                        </NavLink>
                                        <NavLink to="/programs/research-innovation" className={dropdownLinkClasses} onClick={() => setProgramsDropdownOpen(false)}>
