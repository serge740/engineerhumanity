...
const galleryImages: GalleryImage[] = [
    ...
    { id: 2, image: image2, description: "Engineers4Humanity Rwanda Team, 2020,  with Theo Karegesa, Engineers4Humanity Board Vice Chair and Eric Kamanzi, Founder & CEO on the left in blue shirts." },
    { id: 3, image: image3, description: "Hope School 1st intake students of 2009 " },
    { id: 4, image: image4, description: "From Left is Mr Musuhuke, our Alum who is serving as a volunteer, and Fr. Malisaba, Engineers4Humanity Vice-Board Chair in charge of Education, in the middle during the visit of sponsored students." },
    { id: 5, image: image5, description: "Eric is in a meeting with our short-course trainees at the Engineers4Humanity Center for skills development, research, and Innovation 2020 in Gihembe Refugee camp." },
    { id: 6, image: image6, description: "Meeting with Dr. Apotre Paul Gitwaza and sharing his book during the Rwanda Convention held in Dallas, July 2025" },
        ...
        <section className="py-12 px-4 sm:px-8 lg:px-16 lg:py-24 bg-[#F0F7FF]">
            ...
            <div className="text-center mb-14">
                ...
                <p className="mt-4 text-base leading-relaxed max-w-2xl mx-auto text-[#3A5068]">
                    Explore the milestones and moments that have shaped Engineers4Humanity. From our humble beginnings to transformative partnerships, each image tells a story of hope, resilience, and impact in refugee communities.
                </p>
            </div>
