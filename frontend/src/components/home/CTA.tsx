    ...
    <section className="py-12 px-4 sm:px-8 lg:px-16 lg:py-28 bg-[#E1EEF9] grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-20 items-start" id="join">
        ...
        <div>
            ...
            <div className="flex gap-4 flex-wrap">
                ...
                <Link to="/donate" className="bg-emerald-600 hover:bg-emerald-700 text-white px-9 py-4 text-[13px] font-bold tracking-[0.08em] uppercase rounded-[3px] no-underline transition-colors">
                    Donate Now
                </Link>
            </div>
        </div>
