...
const Programs = () => (
    <section className="px-16 pb-28 bg-[#F0F7FF]" id="programs">
        {/* Header */}
        <div className="flex justify-between items-end mb-12 border-t border-sky-200/60 pt-12">
            ...
            <p className="text-[15px] leading-[1.8] text-[#3A5068] max-w-[300px] text-right">
        ...
        {/* Featured band */}
        <div className="bg-[#0A1628] rounded-[6px] px-14 py-12 flex items-center gap-12 flex-wrap">
