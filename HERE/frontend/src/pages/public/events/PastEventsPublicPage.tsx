...
export default function PastEventsPublicPage() {
  ...
  useEffect(() => {
    getPublicEvents('past').then(setEvents).finally(() => setLoading(false));
  }, []);

  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50">
      <EventHero title="Past Events" linkTitle="Past Events" linkHref="/past-event" />
      ...
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        {loading ? (
          ...
          <p className="text-center text-gray-500">No past events published yet.</p>
        ) : (
