...
export default function UpcomingEventsPublicPage() {
  ...
  useEffect(() => {
    getPublicEvents('upcoming').then(setEvents).finally(() => setLoading(false));
  }, []);

  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50">
      <EventHero title="Upcoming Events" linkTitle="Events" linkHref="/upcoming-event" />
      ...
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        {loading ? (
          ...
          <p className="text-center text-gray-500">No upcoming events published yet.</p>
        ) : (
